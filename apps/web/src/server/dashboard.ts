...
import { startOfWeek, addDays, type CalendarEntry } from '@/module/dashboard/week';
...
/**
 * Everything the dashboard needs for the week containing `now`.
 *
 ...
 */
export async function loadDashboardWeek(
  userId: string,
  now: Date,
