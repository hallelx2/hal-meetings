 ...
 *
 * Only destinations that exist are listed. Meetings (HAL-804) and Ask (HAL-806)
 * join this array when their screens land — a nav entry pointing at a 404, or at
 * a placeholder that says "coming soon", teaches people the nav lies.
 */
export type NavItem = {
  href: string;
  label: string;
